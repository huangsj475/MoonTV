...
const EpisodeSelector: React.FC<EpisodeSelectorProps> = ({
 ...
 // 2.找到当前选中的源对象--------- 
  ...
  return (
    <div className='md:ml-2 px-2 py-0 h-full rounded-xl bg-black/10 dark:bg-white/5 flex flex-col border border-white/0 dark:border-white/30 overflow-hidden'>
      {/* 主要的 Tab 切换 - 无缝融入设计 */}
    ...
    episodeLabel = nameLabel.replace(/-|\.|\s/g, '');
              ...
              return (
                <button
                  ...
                  className={`h-10 flex items-center justify-center text-sm font-medium rounded-md transition-all duration-200 whitespace-normal break-words
                    ${
                      isActive
