    ...
    >
      ...
      <div className='relative aspect-[2/3] overflow-hidden rounded-lg'>
		...
		{config.showRemarks && actualRemarks && (
		  <div className="absolute bottom-1 left-1 z-10 bg-black/70 text-white px-1.5 py-1 rounded overflow-hidden opacity-100 group-hover:opacity-0 transition-opacity duration-300 ease-in-out text-[0.7rem] sm:text-xs leading-tight">
		    {actualRemarks}
		  </div>
		)}
        {/* 操作按钮 */}
